...
{
    public class PropertyDriverM
    {
        private const decimal BookDefaultPrice = 10;
        private ActionResult _result;
        private readonly CatalogContext _context;
        public DemoPPCRentalEntities db = new DemoPPCRentalEntities();

        public PropertyDriverM(CatalogContext context)
        {
            _context = context;
        }
        ...
        {
            DemoPPCRentalEntities get = new DemoPPCRentalEntities();
            // Gia lap controller
            Controllers.UserController user = new Controllers.UserController();
            ...
            var us = get.USERs.FirstOrDefault(x => x.Email == "buibao1997@gmail.com");
        ...
        public void ShowList(Table expectednameList)
        {
            ...
            //Assert
            var shownProperties = _result.Model<IEnumerable<PROPERTy>>();
            PropertyAssertions.HomeScreenShouldShow(shownProperties, expectedProjects);
        }
    }
}
