...
//                actionResult.Model<Models.ShoppingCart>().Lines.Should().HaveCount(expectedAmount);
//            }
//        }
...
//            {
//                var actionResult = controller.Index();
//                actionResult.Model<Models.ShoppingCart>().Count.Should().Be(expectedQuantity);
//            }
//        }
...
//            {
//                var actionResult = controller.Index();
//                actionResult.Model<Models.ShoppingCart>().Price.Should().Be(expectedTotalPrice);
//            }
//        }
...
//            {
//                var actionResult = controller.Index();
//                actionResult.Model<Models.ShoppingCart>().Lines
